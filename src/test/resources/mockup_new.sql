...
VALUES
	('Member'),
	('Admin');
-- Populate Users (using plain password for testing)
...
INSERT INTO setlists_songs (id_setlist, id_song) VALUES
    ...
    (2, 3),  -- Coldplay - Fix You
    (2, 4),  -- Coldplay - Yellow
    (3, 5),  -- Beatles - Hey Jude
    (3, 6),  -- Beatles - Let It Be
    (4, 7),  -- Metallica - Enter Sandman
    (4, 8);  -- Metallica - Master of Puppets
